...
h3. Liferay - Real Time  module

	The aim of the Liferay-Real-Time portlet is to show the users navigation activity and history in an animated and interactive graphic. For this it uses the power of SENSE and some graphics libraries such as CHAP Timeline and CHAP Network. The portlet is fully configurable, scalable and can be used in Liferay 6.1 portal.
